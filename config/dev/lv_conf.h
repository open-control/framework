 ...
 * ==========================
 * This file is used for Open Control framework development/testing builds.
 *
 * CONSUMERS MUST PROVIDE THEIR OWN lv_conf.h
 * - Copy this file to your project
 * - Customize settings for your hardware (memory, color depth, features)
 * - Add -I path/to/your/config in build_flags
 *
 * The framework does NOT ship lv_conf.h - LVGL configuration is consumer responsibility.
 */
